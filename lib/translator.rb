...
def get_japanese_emoticon(file_path, english_emoticon)
 ...
 japanese_result_emoticon ? japanese_result_emoticon : "Sorry, that emoticon was not found"
  ...
  #A Terinary is a return statement no need to put a return value  at the end. (implictly returns)
  
end

def get_english_meaning (file_path, japanese_emoticon)
  call_library = load_library(file_path)
  english_result_emoticon = call_library["get_emoticon"][japanese_emoticon]
  english_result_emoticon ? english_result_emoticon : "sad "
